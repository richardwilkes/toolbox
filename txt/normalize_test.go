...
func TestNormalizeLineEndings(t *testing.T) {
	...
	// Test empty string
	c.Equal("", NormalizeLineEndings(""))

	// Test string with no line endings
	c.Equal("hello world", NormalizeLineEndings("hello world"))

	// Test string with only LF (Unix) - should remain unchanged
	c.Equal("line1\nline2", NormalizeLineEndings("line1\nline2"))
	c.Equal("line1\nline2\nline3", NormalizeLineEndings("line1\nline2\nline3"))
	...
	c.Equal("line1\nline2", NormalizeLineEndings("line1\rline2"))
	c.Equal("line1\nline2\nline3", NormalizeLineEndings("line1\rline2\rline3"))

	// Test mixed line endings - should all convert to LF
	c.Equal("line1\nline2\nline3\nline4", NormalizeLineEndings("line1\r\nline2\rline3\nline4"))
	c.Equal("line1\nline2\nline3\nline4\nline5", NormalizeLineEndings("line1\nline2\r\nline3\rline4\nline5"))

	// Test multiple consecutive line endings
	c.Equal("line1\n\nline2", NormalizeLineEndings("line1\r\n\r\nline2"))
	c.Equal("line1\n\nline2", NormalizeLineEndings("line1\r\rline2"))
	c.Equal("line1\n\n\nline2", NormalizeLineEndings("line1\r\n\r\n\r\nline2"))

	// Test string starting with line endings
	c.Equal("\nline1", NormalizeLineEndings("\r\nline1"))
	c.Equal("\nline1", NormalizeLineEndings("\rline1"))
	c.Equal("\nline1", NormalizeLineEndings("\nline1"))

	// Test string ending with line endings
	c.Equal("line1\n", NormalizeLineEndings("line1\r\n"))
	c.Equal("line1\n", NormalizeLineEndings("line1\r"))
	c.Equal("line1\n", NormalizeLineEndings("line1\n"))
	...
	c.Equal("\n", NormalizeLineEndings("\n"))
	c.Equal("\n\n", NormalizeLineEndings("\r\n\r\n"))
	c.Equal("\n\n", NormalizeLineEndings("\r\r"))
	c.Equal("\n\n", NormalizeLineEndings("\n\n"))

	// Test complex mixed scenarios
	c.Equal("\nstart\nmiddle\nend\n", NormalizeLineEndings("\r\nstart\rmiddle\r\nend\n"))
	c.Equal("a\nb\nc\nd\ne", NormalizeLineEndings("a\r\nb\rc\nd\r\ne"))

	// Test text with special characters and line endings
	c.Equal("Special: @#$%\nMore text", NormalizeLineEndings("Special: @#$%\r\nMore text"))
	c.Equal("Unicode: 🚀\nEmoji text", NormalizeLineEndings("Unicode: 🚀\rEmoji text"))
	...
	c.Equal(longText+"\nSecond line", NormalizeLineEndings(longText+"\r\nSecond line"))
	c.Equal(longText+"\nSecond line", NormalizeLineEndings(longText+"\rSecond line"))

	// Test multiple different line ending patterns in sequence
	c.Equal("a\n\n\nb", NormalizeLineEndings("a\r\n\r\rb"))
	c.Equal("a\n\n\nb", NormalizeLineEndings("a\r\r\n\rb"))
	c.Equal("a\n\n\nb", NormalizeLineEndings("a\n\r\n\rb"))

	// Test text with numbers and line endings
	c.Equal("123\n456\n789", NormalizeLineEndings("123\r\n456\r789"))
	c.Equal("1.0\n2.5\n3.14", NormalizeLineEndings("1.0\r2.5\r\n3.14"))
	...
	c.Equal("col1\tcol2\nrow2", NormalizeLineEndings("col1\tcol2\r\nrow2"))
	c.Equal("  spaced  \n  text  ", NormalizeLineEndings("  spaced  \r  text  "))
}
