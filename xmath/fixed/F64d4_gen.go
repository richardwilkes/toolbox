...
var (
	F64d4One     = F64d4FromInt(1)
	F64d4Half    = F64d4FromStringForced("0.5")
	F64d4NegHalf = -F64d4Half
)

var multiplierF64d4 = int64(math.Pow(10, 4))

// F64d4 holds a fixed-point value that contains up to 4 decimal places. Values are truncated, not rounded. Values can
...
// F64d4FromFloat32 creates a new F64d4 value from a float32.
func F64d4FromFloat32(value float32) F64d4 {
	return F64d4(float64(value) * float64(multiplierF64d4))
}
...
// F64d4FromInt creates a new F64d4 value from an int.
func F64d4FromInt(value int) F64d4 {
	return F64d4(int64(value) * multiplierF64d4)
}
...
func (f F64d4) Min(value F64d4) F64d4 {
	if f < value {
		return f
	}
	return value
...
func (f F64d4) Max(value F64d4) F64d4 {
	if f > value {
		return f
	}
	return value
...
func (f F64d4) AsFloat32() float32 {
...
// float32.
func (f F64d4) Float32() (float32, error) {
	n := f.AsFloat32()
...
func (f *F64d4) UnmarshalText(text []byte) error {
	f1, err := F64d4FromString(unquote(text))
	if err != nil {
		return err
	}
	*f = f1
...
func (f *F64d4) UnmarshalJSON(in []byte) error {
	v, err := F64d4FromString(unquote(in))
	if err != nil {
		return err
	}
	*f = v
