...
var (
	multiplierBigInt   = new(big.Int).Exp(big.NewInt(10), big.NewInt(11), nil)
...
func FromFloat64(value float64) Int {
	f, _ := FromString(new(big.Float).SetPrec(128).SetFloat64(value).Text('f', 12)) //nolint:errcheck // Failure means 0
	return f
}
