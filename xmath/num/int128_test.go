...
func TestInt128GreaterOrEqualTo(t *testing.T) {
	assert.Equal(t, true, num.Int128From64(0).GreaterThanOrEqual(num.Int128From64(0)))
	assert.Equal(t, false, num.Int128From64(-2).GreaterThanOrEqual(num.Int128From64(-1)))
	assert.Equal(t, false, num.Int128From64(1).GreaterThanOrEqual(num.Int128From64(2)))
	assert.Equal(t, false, num.Int128From64(-1).GreaterThanOrEqual(num.Int128From64(1)))
	assert.Equal(t, false, num.Int128From64(-2).GreaterThanOrEqual(num.Int128From64(1)))
	assert.Equal(t, false, num.Int128From64(22).GreaterThanOrEqual(num.Int128From64(98)))
	assert.Equal(t, false, num.MinInt128.GreaterThanOrEqual(num.Int128From64(1)))
	assert.Equal(t, false, num.MinInt128.GreaterThanOrEqual(num.MaxInt128))
	assert.Equal(t, true, num.MaxInt128.GreaterThanOrEqual(num.MaxInt128))
	assert.Equal(t, true, num.MinInt128.GreaterThanOrEqual(num.MinInt128))
	assert.Equal(t, true, num.Int128From64(-1).GreaterThanOrEqual(num.Int128From64(-2)))
	assert.Equal(t, true, num.Int128From64(1).GreaterThanOrEqual(num.Int128From64(-1)))
	assert.Equal(t, true, num.Int128FromComponents(0, 0xFFFFFFFFFFFFFFFF).GreaterThanOrEqual(num.Int128From64(-1)))
	assert.Equal(t, true, num.Int128FromComponents(1, 0).GreaterThanOrEqual(num.Int128From64(1)))
	assert.Equal(t, true, num.MaxInt128.GreaterThanOrEqual(num.Int128From64(-1)))
	assert.Equal(t, true, num.MaxInt128.GreaterThanOrEqual(num.MinInt128))
}
...
func TestInt128LessOrEqualTo(t *testing.T) {
	assert.Equal(t, true, num.Int128From64(0).LessThanOrEqual(num.Int128From64(0)))
	assert.Equal(t, true, num.Int128From64(-2).LessThanOrEqual(num.Int128From64(-1)))
	assert.Equal(t, true, num.Int128From64(1).LessThanOrEqual(num.Int128From64(2)))
	assert.Equal(t, true, num.Int128From64(-1).LessThanOrEqual(num.Int128From64(1)))
	assert.Equal(t, true, num.Int128From64(-2).LessThanOrEqual(num.Int128From64(1)))
	assert.Equal(t, true, num.Int128From64(22).LessThanOrEqual(num.Int128From64(98)))
	assert.Equal(t, true, num.MinInt128.LessThanOrEqual(num.Int128From64(1)))
	assert.Equal(t, true, num.MinInt128.LessThanOrEqual(num.MaxInt128))
	assert.Equal(t, true, num.MaxInt128.LessThanOrEqual(num.MaxInt128))
	assert.Equal(t, true, num.MinInt128.LessThanOrEqual(num.MinInt128))
	assert.Equal(t, false, num.Int128From64(-1).LessThanOrEqual(num.Int128From64(-2)))
	assert.Equal(t, false, num.Int128From64(1).LessThanOrEqual(num.Int128From64(-1)))
	assert.Equal(t, false, num.Int128FromComponents(0, 0xFFFFFFFFFFFFFFFF).LessThanOrEqual(num.Int128From64(-1)))
	assert.Equal(t, false, num.Int128FromComponents(1, 0).LessThanOrEqual(num.Int128From64(1)))
	assert.Equal(t, false, num.MaxInt128.LessThanOrEqual(num.Int128From64(-1)))
	assert.Equal(t, false, num.MaxInt128.LessThanOrEqual(num.MinInt128))
}
