...
func testUnion[T constraints.Float](t *testing.T) {
	tests := []testCase[T]{
		...
		},
		{
			...
			expected: poly.Polygon[T]{{{90.0945, 79.13637}, {55.094494, 139.75815}, {66.592064, 159.67252}, {90.0945, 200.37993}, {160.0945, 200.37993}}},
		},
		{
			name:     "union #9",
			...
			expected: poly.Polygon[T]{{{70.784325, -7.668842}, {42.500053, -19.384571}, {22.504997, -11.102347}, {14.215784, -7.668842}, {22.504997, -11.102347}, {16.729664, -13.494569}, {-23.270336, 26.50543}, {-18.45379, 38.1336}, {-28.102259, 61.427063}}},
		},
		{
			name:     "union #10",
		...
		},
		{
			...
			expected: poly.Polygon[T]{{{82.50005, 20.615429}, {42.500053, -19.384571}, {2.500055, 20.615429}, {7.6047134, 25.720087}, {7.604714, 25.720087}, {32.55986, 50.675236}, {42.500053, 60.61543}}},
		},
		{
...
func testSubtract[T constraints.Float](t *testing.T) {
	tests := []testCase[T]{
		...
		},
		{
			...
			subject:  poly.Polygon[T]{{{2.500055, 20.615429}, {42.500055, -19.384571}, {82.500055, 20.615429}, {42.500055, 60.615429}}},
			clipping: poly.Polygon[T]{{{7.604714, 25.720088}, {32.55986, 50.675234}, {36.852887, 46.382207}, {11.897741, 21.427062}}},
			expected: poly.Polygon[T]{{{82.50005, 20.615429}, {42.500053, -19.384571}, {2.500055, 20.615429}, {7.6047134, 25.720087}, {7.604714, 25.720087}, {11.897741, 21.427061}, {36.852886, 46.382206}, {32.55986, 50.675236}, {42.500053, 60.61543}}},
		},
		{
			name:     "subtract #3",
		...
		},
		{
			...
			expected: poly.Polygon[T]{{{426732.4, -668549.6}, {426714.56, -668548.94}, {426694.62, -668547.2}}},
		},
		{
			name:     "subtract #7",
			subject:  poly.Polygon[T]{{{38.572124, 172.339556}, {40, 171.339746}, {41.579799, 170.603074}, {43.263518, 170.151922}, {45, 170}, {46.736482, 170.151922}, {48.420201, 170.603074}, {50, 171.339746}, {51.427876, 172.339556}}},
