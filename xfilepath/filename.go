...
func TrimExtension(path string) string {
	...
	// A leading dot marks a hidden file (e.g. ".bashrc") rather than an extension, so if filepath.Ext matched the
	// entire final path element there is nothing to trim.
