...
func TestContains(t *testing.T) {
	...
	containsTests := []containsCase{
		{Point: geom.Point{X: 199, Y: 20}, contains: false},
		{Point: geom.Point{X: 200, Y: 20}, contains: true},
		{Point: geom.Point{X: 300, Y: 120}, contains: true},
		{Point: geom.Point{X: 250, Y: 50}, contains: true},
		{Point: geom.Point{X: 260, Y: 60}, contains: true},
		{Point: geom.Point{X: 290, Y: 110}, contains: true},
		{Point: geom.Point{X: 319, Y: 139}, contains: true},
		{Point: geom.Point{X: 321, Y: 140}, contains: false},
		{Point: geom.Point{X: 320, Y: 141}, contains: false},
	}
	...
	containsEvenOddTests := []containsCase{
		...
		{Point: geom.Point{X: 200, Y: 20}, contains: true},
		{Point: geom.Point{X: 300, Y: 120}, contains: true},
		{Point: geom.Point{X: 250, Y: 50}, contains: false},
		{Point: geom.Point{X: 260, Y: 60}, contains: true},
		{Point: geom.Point{X: 290, Y: 110}, contains: false},
		{Point: geom.Point{X: 319, Y: 139}, contains: true},
		{Point: geom.Point{X: 321, Y: 140}, contains: false},
		{Point: geom.Point{X: 320, Y: 141}, contains: false},
	}
...
type testCase struct {
	name     string
	subject  poly.Polygon
	clipping poly.Polygon
	expected poly.Polygon
}
...
func TestUnion(t *testing.T) {
	...
	tests := []testCase{
		{
			name:    "union #1",
			subject: poly.Polygon{{{1, 1}, {1, 2}, {2, 2}, {2, 1}}},
			clipping: poly.Polygon{
				{{2, 1}, {2, 2}, {3, 2}, {3, 1}},
				{{1, 2}, {1, 3}, {2, 3}, {2, 2}},
				{{2, 2}, {2, 3}, {3, 3}, {3, 2}},
			},
			expected: poly.Polygon{{{3, 2}, {3, 1}, {1, 1}, {1, 2}, {1, 3}, {3, 3}}},
		},
		{
			name:     "union #2",
			subject:  poly.Polygon{{{2, 1}, {1, 2}, {2, 2}}},
			clipping: poly.Polygon{{{1, 2}, {2, 2}, {2, 3}, {1, 2}, {2, 2}, {2, 3}}},
			expected: poly.Polygon{{{2, 1}, {1, 2}, {2, 2}}},
		},
		{
			name:    "union #3",
			subject: poly.Polygon{{{1, 2}, {2, 2}, {2, 1}}},
			clipping: poly.Polygon{
				{{2, 1}, {2, 2}, {3, 2}},
				{{1, 2}, {2, 3}, {2, 2}},
				{{2, 2}, {2, 3}, {3, 2}},
			},
			expected: poly.Polygon{{{3, 2}, {2, 1}, {1, 2}, {2, 3}}},
		},
		{
			name:    "union #4",
			subject: poly.Polygon{{{1, 2}, {2, 2}, {2, 1}}},
			...
			expected: poly.Polygon{{{3, 2}, {2, 2}, {2, 1}, {1, 2}, {2, 3}}},
		},
		{
			name:     "union #5",
			subject:  poly.Polygon{{{1, 2}, {2, 2}, {2, 1}}},
			clipping: poly.Polygon{{{1, 2}, {2, 3}, {2, 2}, {2, 3}, {3, 2}}},
			expected: poly.Polygon{{{3, 2}, {2, 2}, {2, 1}, {1, 2}, {2, 3}}},
		},
		{
			name:    "union #6",
		...
		{
			name:     "union #8",
			subject:  poly.Polygon{{{160.094495, 200.379924}, {90.094495, 200.379924}, {55.094495, 139.758145}, {90.094495, 79.136367}}},
			clipping: poly.Polygon{{{82.846611, 131.518814}, {66.592063, 159.672517}, {90.094495, 200.379924}, {160.094495, 200.379924}}},
		},
		{
			name:     "union #11",
			subject:  poly.Polygon{{{160.094495, 200.379924}, {90.094495, 200.379924}, {55.094495, 139.758146}, {90.094495, 79.136368}}},
			clipping: poly.Polygon{{{82.846611, 131.518814}, {66.592063, 159.672518}, {90.094495, 200.379924}, {160.094495, 200.379924}}},
			expected: poly.Polygon{{{90.0945, 79.13637}, {55.094494, 139.75815}, {66.592064, 159.67252}, {90.0945, 200.37993}, {160.0945, 200.37993}}},
		},
		{
			name:     "union #12",
			subject:  poly.Polygon{{{2.500055, 20.615429}, {42.500055, -19.384571}, {82.500055, 20.615429}, {42.500055, 60.615429}}},
			clipping: poly.Polygon{{{7.604714, 25.720088}, {32.55986, 50.675234}, {36.852887, 46.382207}, {11.897741, 21.427062}}},
			expected: poly.Polygon{{{82.50005, 20.615429}, {42.500053, -19.384571}, {2.500055, 20.615429}, {7.6047134, 25.720087}, {7.604714, 25.720087}, {32.55986, 50.675236}, {42.500053, 60.61543}}},
		},
		{
			name:     "union overlapping segments #1",
			subject:  poly.Polygon{{{0, 0}, {10, 0}, {0, 10}}},
			clipping: poly.Polygon{{{6, 5}, {6, 4}, {5, 5}}},
			expected: poly.Polygon{{{5, 5}, {6, 5}, {6, 4}, {10, 0}, {0, 0}, {0, 10}}},
		},
		{
			name:     "union overlapping segments #2",
			subject:  poly.Polygon{{{0, 0}, {10, 0}, {0, 10}}},
			clipping: poly.Polygon{{{6, 4}, {4, 5}, {5, 5}}},
			expected: poly.Polygon{{{5, 5}, {6, 4}, {10, 0}, {0, 0}, {0, 10}}},
		},
		{
			name:     "union overlapping segments #3",
			subject:  poly.Polygon{{{0, 10}, {10, 10}, {0, 0}}},
			clipping: poly.Polygon{{{6, 5}, {6, 6}, {5, 5}}},
			expected: poly.Polygon{{{6, 6}, {6, 5}, {5, 5}, {0, 0}, {0, 10}, {10, 10}}},
		},
		{
			name:     "union overlapping segments #4",
			subject:  poly.Polygon{{{0, 10}, {10, 10}, {0, 0}}},
			clipping: poly.Polygon{{{5, 5}, {5, 6}, {6, 6}}},
			expected: poly.Polygon{{{6, 6}, {5, 5}, {0, 0}, {0, 10}, {10, 10}}},
		},
		{
			name:     "union overlapping segments #5",
			subject:  poly.Polygon{{{40131, 8372}, {40127, 8374}, {40126, 8375}, {40125, 8375}, {40122, 8377}, {40143, 8369}}},
			clipping: poly.Polygon{{{40106, 8376}, {40128, 8373}, {40126, 8375}}},
			expected: poly.Polygon{{{40143, 8369}, {40131, 8372}, {40127, 8374}, {40128, 8373}, {40106, 8376}, {40124.918919, 8375.054054}, {40122, 8377}}},
		},
		{
			...
			clipping: poly.Polygon{{{5, 5}, {10, 8}, {8, 10}}},
			expected: poly.Polygon{
				{{10, 8}, {5, 5}, {8, 10}},
				{{5, 5}, {0, 6}, {2, 10}},
				{{10, 4}, {4, 0}, {5, 5}},
		...
		},
		{
			...
			clipping: poly.Polygon{{{0, 0.25}, {3, 0.25}, {3, 0.75}, {0, 0.75}}},
			expected: poly.Polygon{{{2, 0.75}, {3, 0.75}, {3, 0.25}, {2, 0.25}, {2, 0}, {0, 0}, {0, 0.25}, {0, 0.75}, {0, 1}, {2, 1}}},
		},
	}
...
func TestIntersect(t *testing.T) {
	...
	tests := []testCase{
		...
		{
			name:     "intersect #13",
			subject:  poly.Polygon{{{0, 10}, {0, 0}, {10, 0}, {10, 10}}},
			clipping: poly.Polygon{{{0, 5}, {5, 0}, {10, 5}, {5, 10}}},
			expected: poly.Polygon{{{10, 5}, {5, 0}, {0, 5}, {5, 10}}},
		},
		{
			...
			clipping: poly.Polygon{{{0, 0.25}, {3, 0.25}, {3, 0.75}, {0, 0.75}}},
			expected: poly.Polygon{{{2, 0.25}, {0, 0.25}, {0, 0.75}, {2, 0.75}}},
		},
	}
	for i, test := range tests {
	...
	tests := []testCase{
		{
			...
			subject:  poly.Polygon{{{160.094495, 200.379924}, {90.094495, 200.379924}, {55.094495, 139.758146}, {90.094495, 79.136368}}},
			clipping: poly.Polygon{{{82.846611, 131.518814}, {66.592063, 159.672518}, {90.094495, 200.379924}, {160.094495, 200.379924}}},
			expected: poly.Polygon{{{90.094495, 79.136368}, {55.094495, 139.758146}, {66.592063, 159.672518}, {82.846611, 131.518814}, {160.094495, 200.379924}}},
		},
		{
			name:     "subtract #2",
			subject:  poly.Polygon{{{2.500055, 20.615429}, {42.500055, -19.384571}, {82.500055, 20.615429}, {42.500055, 60.615429}}},
			clipping: poly.Polygon{{{7.604714, 25.720088}, {32.55986, 50.675234}, {36.852887, 46.382207}, {11.897741, 21.427062}}},
			expected: poly.Polygon{{{82.50005, 20.615429}, {42.500053, -19.384571}, {2.500055, 20.615429}, {7.6047134, 25.720087}, {7.604714, 25.720087}, {11.897741, 21.427061}, {36.852886, 46.382206}, {32.55986, 50.675236}, {42.500053, 60.61543}}},
		},
		{
			name:     "subtract #3",
			subject:  poly.Polygon{{{38.572124, 172.339556}, {40, 171.339746}, {41.579799, 170.603074}, {43.263518, 170.151922}, {45, 170}, {46.736482, 170.151922}, {48.420201, 170.603074}, {50, 171.339746}, {51.427876, 172.339556}}},
			clipping: poly.Polygon{{{51.427876, 172.339556}, {50, 171.339746}, {48.420201, 170.603074}, {46.736482, 170.151922}, {45, 170}, {43.263518, 170.151922}, {42.781168, 170.281168}, {42.651922, 170.763518}, {42.5, 172}}},
			expected: poly.Polygon{{{42.5, 172}, {42.651922, 170.763518}, {42.781168, 170.281168}, {43.263518, 170.151922}, {41.579799, 170.603074}, {40, 171.339746}, {38.572124, 172.339556}, {51.427876, 172.339556}}},
		},
		{
			name:     "subtract #4",
			subject:  poly.Polygon{{{24, 7}, {36, 7}, {36, 23}, {24, 23}}},
			clipping: poly.Polygon{{{24, 7}, {24.836228, 7.043825}, {25.663294, 7.174819}, {26.472136, 7.391548}, {27.253893, 7.691636}, {28, 8.071797}, {28.702282, 8.527864}, {29.353045, 9.054841}, {29.945159, 9.646955}, {30.472136, 10.297718}, {30.928203, 11}, {31.308364, 11.746107}, {31.608452, 12.527864}, {31.825181, 13.336706}, {31.956175, 14.163772}, {32, 15}, {31.956175, 15.836228}, {31.825181, 16.663294}, {31.608452, 17.472136}, {31.308364, 18.253893}, {30.928203, 19}, {30.472136, 19.702282}, {29.945159, 20.353045}, {29.353045, 20.945159}, {28.702282, 21.472136}, {28, 21.928203}, {27.253893, 22.308364}, {26.472136, 22.608452}, {25.663294, 22.825181}, {24.836228, 22.956175}, {24, 23}, {23.163772, 22.956175}, {22.336706, 22.825181}, {21.527864, 22.608452}, {20.746107, 22.308364}, {20, 21.928203}, {19.297718, 21.472136}, {18.646955, 20.945159}, {18.054841, 20.353045}, {17.527864, 19.702282}, {17.071797, 19}, {16.691636, 18.253893}, {16.391548, 17.472136}, {16.174819, 16.663294}, {16.043825, 15.836228}, {16, 15}, {16.043825, 14.163772}, {16.174819, 13.336706}, {16.391548, 12.527864}, {16.691636, 11.746107}, {17.071797, 11}, {17.527864, 10.297718}, {18.054841, 9.646955}, {18.646955, 9.054841}, {19.297718, 8.527864}, {20, 8.071797}, {20.746107, 7.691636}, {21.527864, 7.391548}, {22.336706, 7.174819}, {23.163772, 7.043825}}},
			expected: poly.Polygon{{{36, 7}, {24, 7}, {24.836228, 7.043825}, {25.663294, 7.174819}, {26.472136, 7.391548}, {27.253893, 7.691636}, {28, 8.071797}, {28.702282, 8.527864}, {29.353045, 9.054841}, {29.945159, 9.646955}, {30.472136, 10.297718}, {30.928203, 11}, {31.308364, 11.746107}, {31.608452, 12.527864}, {31.825181, 13.336706}, {31.956175, 14.163772}, {32, 15}, {31.956175, 15.836228}, {31.825181, 16.663294}, {31.608452, 17.472136}, {31.308364, 18.253893}, {30.928203, 19}, {30.472136, 19.702282}, {29.945159, 20.353045}, {29.353045, 20.945159}, {28.702282, 21.472136}, {28, 21.928203}, {27.253893, 22.308364}, {26.472136, 22.608452}, {25.663294, 22.825181}, {24.836228, 22.956175}, {24, 23}, {36, 23}}},
		},
		{
			name:     "subtract #5",
			subject:  poly.Polygon{{{114, 0}, {161, 0}, {114, 168}}},
			clipping: poly.Polygon{{{99, 164}, {114, 108}, {121, 164}}},
			expected: poly.Polygon{
				{{115.11905, 164}, {114, 164}, {114, 168}},
				{{161, 0}, {114, 0}, {114, 108}, {119.18382, 149.4706}},
			},
		},
		{
			name:     "subtract #6",
			subject:  poly.Polygon{{{426694.636527, -668547.161158}, {426714.57523, -668548.923865}, {426745.396481, -668550.465125}}},
			clipping: poly.Polygon{{{426714.57523, -668548.923865}, {426744.637187, -668550.05919}, {426745.396482, -668550.465224}}},
			expected: poly.Polygon{{{426732.4, -668549.6}, {426714.56, -668548.94}, {426694.62, -668547.2}}},
		},
		{
			name:     "subtract #7",
			subject:  poly.Polygon{{{38.572124, 172.339556}, {40, 171.339746}, {41.579799, 170.603074}, {43.263518, 170.151922}, {45, 170}, {46.736482, 170.151922}, {48.420201, 170.603074}, {50, 171.339746}, {51.427876, 172.339556}}},
...
func matchPolys(left, right poly.Polygon) bool {
...
func simplifyPoly(p poly.Polygon) poly.Polygon {
	var revised poly.Polygon
	for _, c := range p {
		var nc poly.Contour
		for i, pt := range c {
