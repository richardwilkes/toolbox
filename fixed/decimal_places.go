...
// ErrDoesNotFitInRequestedType is returned from the fixed-point AsIntegerChecked() and AsFloatChecked() functions if
// the requested type cannot exactly represent the value.
